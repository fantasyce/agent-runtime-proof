...
```bash
asset=agent-runtime-proof_1.0.0_darwin_arm64.tar.gz
...
```powershell
$Asset = 'agent-runtime-proof_1.0.0_windows_amd64.zip'
...
tar -xzf agent-runtime-proof_1.0.0_darwin_arm64.tar.gz
install -m 0755 agent-runtime-proof_1.0.0_darwin_arm64/agent-runtime-proof \
...
`agent-runtime-proof_1.0.0_linux_amd64.tar.gz`. Install to
...
Expand-Archive agent-runtime-proof_1.0.0_windows_amd64.zip -DestinationPath . -Force
Copy-Item .\agent-runtime-proof_1.0.0_windows_amd64\agent-runtime-proof.exe \
...
The Release also contains `agent-runtime-proof_1.0.0_source.tar.gz`. Extract it
