...
| ARP-P1-006 | Closed / passed for development CI | Independent private repository `fantasyce/agent-runtime-proof` was created without a release or license decision. GitHub Actions run `32763518762` passed macOS Go 1.26/1.27, Ubuntu amd64, and Windows 2025 jobs. | Public visibility, license approval, protected-branch policy, signed release assets, and provenance remain Phase 5 release gates. |
