...
test "$(tr -d '\r\n' < VERSION)" = "1.1.0"
grep -Fq 'version = "1.1.0-dev"' cmd/agent-runtime-proof/main.go
test "$(jq -r '.version' plugin/agent-runtime-proof/.codex-plugin/plugin.json)" = "1.1.0"
...
grep -Fq '## [1.1.0] - 2026-08-27' CHANGELOG.md
grep -Fq 'releases/tag/v1.1.0' README.md
grep -Fq 'docs/install.md' README.md
grep -Fq 'agent-runtime-proof_1.1.0.mcpb' docs/install.md
