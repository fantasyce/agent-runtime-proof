...
test "$(tr -d '\r\n' < VERSION)" = "1.0.1"
grep -Fq 'version = "1.0.1-dev"' cmd/agent-runtime-proof/main.go
test "$(jq -r '.version' plugin/agent-runtime-proof/.codex-plugin/plugin.json)" = "1.0.1"
...
grep -Fq '## [1.0.1] - 2026-08-26' CHANGELOG.md
grep -Fq 'releases/tag/v1.0.1' README.md
